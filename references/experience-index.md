...
5. Read `experience/pitfalls.md` when evidence conflicts, a tool result is surprising, or two cycles fail to advance.
...
| Authorized assessment/tooling | `pentest.md` | `scanner.md`, `tools.md`, `../skills/sec-assessment-tooling/pentest-tools/` |
